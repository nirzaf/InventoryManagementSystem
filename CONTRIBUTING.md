...
- Search existing [issues](https://github.com/YOUR_ORG/InventoryManagementSystem/issues) to avoid duplicates
...
Open a [Discussion](https://github.com/YOUR_ORG/InventoryManagementSystem/discussions) or ask in an issue.
